...
import com.lonru.community.service.BoardService;
...
public class BoardController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (cmd.equals("saveForm")) {
			...
			List<Reply> replys = replyService.댓글전체보기(id);
			if (dto == null) {
...
//			String respData = gson.toJson(respDto);
			CommonDto<String> commonDto = new CommonDto<>(result);
			commonDto.setData("성공");

			Gson gson = new Gson();
			String respData = gson.toJson(commonDto);
